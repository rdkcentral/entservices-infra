...
TEST_F(USBDeviceTest, GetDeviceInfo_DeviceNotFound)
{
    Mock_SetSerialNumberInUSBDevicePath();
    Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
    ...
    EXPECT_EQ(Core::ERROR_GENERAL, handler.Invoke(connection, _T("getDeviceInfo"), _T("{\"deviceName\":\"200\\/002\"}"), response));
}

TEST_F(USBDeviceTest, GetDeviceInfo_NoDevicesConnected)
{
    ON_CALL(*p_libUSBImplMock, libusb_get_device_list(::testing::_, ::testing::_))
...
TEST_F(USBDeviceTest, GetDeviceList_NoDevices)
{
    ON_CALL(*p_libUSBImplMock, libusb_get_device_list(::testing::_, ::testing::_))
    .WillByDefault(::testing::Return(0));
...
TEST_F(USBDeviceTest, GetDeviceList_FailedToGetDeviceDescriptor)
{
    Mock_SetSerialNumberInUSBDevicePath();
    ...
    [](libusb_context *ctx, libusb_device ***list) {
        ...
        else
        {
            for (int index = 0; index < len; ++index)
            {
                ...
                {
                    ret[index]->bus_number = MOCK_USB_DEVICE_BUS_NUMBER_1;
                    ret[index]->device_address = MOCK_USB_DEVICE_ADDRESS_1;
                    ret[index]->port_number = MOCK_USB_DEVICE_PORT_1;
                }
            }
            *list = ret;
        }
...
TEST_F(USBDeviceTest, BindDriver_DeviceNotFound)
{
    ...
    EXPECT_EQ(Core::ERROR_GENERAL, handler.Invoke(connection, _T("bindDriver"), _T("{\"deviceName\":\"200\\/002\"}"), response));
}

TEST_F(USBDeviceTest, BindDriver_FailedToOpen)
{
    Mock_SetSerialNumberInUSBDevicePath();
    Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
TEST_F(USBDeviceTest, BindDriver_KernelDriverAlreadyActive)
{
    Mock_SetSerialNumberInUSBDevicePath();
    Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
TEST_F(USBDeviceTest, BindDriver_AttachDriverFailed)
{
    Mock_SetSerialNumberInUSBDevicePath();
    Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
TEST_F(USBDeviceTest, BindDriver_KernelDriverActiveCheckFailed)
{
    Mock_SetSerialNumberInUSBDevicePath();
    Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
TEST_F(USBDeviceTest, UnbindDriver_DeviceNotFound)
{
    Mock_SetSerialNumberInUSBDevicePath();
    ...
    EXPECT_EQ(Core::ERROR_GENERAL, handler.Invoke(connection, _T("unbindDriver"), _T("{\"deviceName\":\"200\\/002\"}"), response));
}

TEST_F(USBDeviceTest, UnbindDriver_FailedToOpen)
{
    Mock_SetSerialNumberInUSBDevicePath();
    Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
TEST_F(USBDeviceTest, UnbindDriver_NoKernelDriverActive)
{
    Mock_SetSerialNumberInUSBDevicePath();
    Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
TEST_F(USBDeviceTest, UnbindDriver_DetachDriverFailed)
{
    Mock_SetSerialNumberInUSBDevicePath();
    Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
TEST_F(USBDeviceTest, UnbindDriver_KernelDriverActiveCheckFailed)
{
    Mock_SetSerialNumberInUSBDevicePath();
    Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
TEST_F(USBDeviceTest, GetDeviceInfo_LanguageDescriptor_Success)
{
    struct libusb_config_descriptor *temp_config_desc = nullptr;
    Mock_SetSerialNumberInUSBDevicePath();
    Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
TEST_F(USBDeviceTest, GetDeviceInfo_InvalidDescriptorIndex_ZeroIndex)
{
    struct libusb_config_descriptor *temp_config_desc = nullptr;
    Mock_SetSerialNumberInUSBDevicePath();
    Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
TEST_F(USBDeviceTest, GetDeviceInfo_GetUSBExtInfoStructFromDeviceDescriptor_Success)
{
    struct libusb_config_descriptor *temp_config_desc = nullptr;
    Mock_SetSerialNumberInUSBDevicePath();
    Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
    ...
    EXPECT_EQ(Core::ERROR_NONE, handler.Invoke(connection, _T("getDeviceInfo"), _T("{\"deviceName\":\"100\\/001\"}"), response));
    EXPECT_TRUE(response.find("\"numLanguageIds\":1") != std::string::npos);
    EXPECT_TRUE(response.find("\"languageId\":1033") != std::string::npos);
    EXPECT_TRUE(response.find("\"manufacturer\":\"USB\"") != std::string::npos);
    EXPECT_TRUE(response.find("\"product\":\"SanDisk 3.2Gen1\"") != std::string::npos);
}

TEST_F(USBDeviceTest, GetDeviceInfo_GetUSBExtInfoStructFromDeviceDescriptor_OpenDeviceFailure)
{
    struct libusb_config_descriptor *temp_config_desc = nullptr;
    Mock_SetSerialNumberInUSBDevicePath();
    Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
TEST_F(USBDeviceTest, GetDeviceInfo_GetUSBExtInfoStructFromDeviceDescriptor_GetLanguageDescriptorFailure)
{
    struct libusb_config_descriptor *temp_config_desc = nullptr;
    Mock_SetSerialNumberInUSBDevicePath();
    Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
// TEST_F(USBDeviceTest, GetDeviceInfo_GetUSBExtInfoStructFromDeviceDescriptor_TwoLanguageIds)
// {
//     struct libusb_config_descriptor *temp_config_desc = nullptr;
//     Mock_SetSerialNumberInUSBDevicePath();
//     Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
//             return 6;
//         }
//         else if (desc_index == 1 && (langid == 1033 || langid == 1799))
//         {
//             data[1] = LIBUSB_DT_STRING;
//             const char *buf = MOCK_USB_DEVICE_MANUFACTURER;
//             int buffer_len = strlen(buf) * 2, j = 0, index = 2;
...
//             return (int)data[0];
//         }
//         else if (desc_index == 2 && (langid == 1033 || langid == 1799))
//         {
//             data[1] = LIBUSB_DT_STRING;
//             const char *buf = MOCK_USB_DEVICE_PRODUCT;
//             int buffer_len = strlen(buf) * 2, j = 0, index = 2;
...
//             return (int)data[0];
//         }
//         else if (desc_index == 3 && (langid == 1033 || langid == 1799))
//         {
//             data[1] = LIBUSB_DT_STRING;
//             const char *buf = MOCK_USB_DEVICE_SERIAL_NO;
//             int buffer_len = strlen(buf) * 2, j = 0, index = 2;
...
// TEST_F(USBDeviceTest, GetDeviceInfo_GetUSBExtInfoStructFromDeviceDescriptor_ThreeLanguageIds)
// {
//     struct libusb_config_descriptor *temp_config_desc = nullptr;
//     Mock_SetSerialNumberInUSBDevicePath();
//     Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
//             return 8;
//         }
//         else if (desc_index == 1 && (langid == 1033 || langid == 1799 || langid == 2316))
//         {
//             data[1] = LIBUSB_DT_STRING;
//             const char *buf = MOCK_USB_DEVICE_MANUFACTURER;
//             int buffer_len = strlen(buf) * 2, j = 0, index = 2;
...
//             return (int)data[0];
//         }
//         else if (desc_index == 2 && (langid == 1033 || langid == 1799 || langid == 2316))
//         {
//             data[1] = LIBUSB_DT_STRING;
//             const char *buf = MOCK_USB_DEVICE_PRODUCT;
//             int buffer_len = strlen(buf) * 2, j = 0, index = 2;
...
//             return (int)data[0];
//         }
//         else if (desc_index == 3 && (langid == 1033 || langid == 1799 || langid == 2316))
//         {
//             data[1] = LIBUSB_DT_STRING;
//             const char *buf = MOCK_USB_DEVICE_SERIAL_NO;
//             int buffer_len = strlen(buf) * 2, j = 0, index = 2;
...
// TEST_F(USBDeviceTest, GetDeviceInfo_GetUSBExtInfoStructFromDeviceDescriptor_FourLanguageIds)
// {
//     struct libusb_config_descriptor *temp_config_desc = nullptr;
//     Mock_SetSerialNumberInUSBDevicePath();
//     Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
//             return 10;
//         }
//         else if (desc_index == 1 && (langid == 1033 || langid == 1799 || langid == 2316 || langid == 2321))
//         {
//             data[1] = LIBUSB_DT_STRING;
//             const char *buf = MOCK_USB_DEVICE_MANUFACTURER;
//             int buffer_len = strlen(buf) * 2, j = 0, index = 2;
...
//             return (int)data[0];
//         }
//         else if (desc_index == 2 && (langid == 1033 || langid == 1799 || langid == 2316 || langid == 2321))
//         {
//             data[1] = LIBUSB_DT_STRING;
//             const char *buf = MOCK_USB_DEVICE_PRODUCT;
//             int buffer_len = strlen(buf) * 2, j = 0, index = 2;
...
//             return (int)data[0];
//         }
//         else if (desc_index == 3 && (langid == 1033 || langid == 1799 || langid == 2316 || langid == 2321))
//         {
//             data[1] = LIBUSB_DT_STRING;
//             const char *buf = MOCK_USB_DEVICE_SERIAL_NO;
//             int buffer_len = strlen(buf) * 2, j = 0, index = 2;
...
// TEST_F(USBDeviceTest, GetDeviceInfo_GetUSBExtInfoStructFromDeviceDescriptor_MoreThanFourLanguageIds)
// {
//     struct libusb_config_descriptor *temp_config_desc = nullptr;
//     Mock_SetSerialNumberInUSBDevicePath();
//     Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
//             return 12;
//         }
//         else if (desc_index >= 1 && desc_index <= 3)
//         {
//             data[1] = LIBUSB_DT_STRING;
//             const char *buf = (desc_index == 1) ? MOCK_USB_DEVICE_MANUFACTURER :
//                              (desc_index == 2) ? MOCK_USB_DEVICE_PRODUCT :
//                              MOCK_USB_DEVICE_SERIAL_NO;
//             int buffer_len = strlen(buf) * 2, j = 0, index = 2;
//             memset(&data[2], 0, length - 2);
//             while((data[index] = buf[j++]) != '\0')
//             {
...
TEST_F(USBDeviceTest, GetDeviceInfo_GetUSBExtInfoStructFromDeviceDescriptor_GetStringDescriptorFailureForManufacturer)
{
    struct libusb_config_descriptor *temp_config_desc = nullptr;
    Mock_SetSerialNumberInUSBDevicePath();
    Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
TEST_F(USBDeviceTest, GetDeviceInfo_GetUSBExtInfoStructFromDeviceDescriptor_GetStringDescriptorFailureForProduct)
{
    struct libusb_config_descriptor *temp_config_desc = nullptr;
    Mock_SetSerialNumberInUSBDevicePath();
    Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
...
TEST_F(USBDeviceTest, GetDeviceInfo_GetUSBExtInfoStructFromDeviceDescriptor_GetStringDescriptorFailureForSerialNumber)
{
    struct libusb_config_descriptor *temp_config_desc = nullptr;
    Mock_SetSerialNumberInUSBDevicePath();
    Mock_SetDeviceDesc(MOCK_USB_DEVICE_BUS_NUMBER_1, MOCK_USB_DEVICE_ADDRESS_1);
    ...
    EXPECT_EQ(Core::ERROR_NONE, handler.Invoke(connection, _T("getDeviceInfo"), _T("{\"deviceName\":\"100\\/001\"}"), response));
    EXPECT_TRUE(response.find("\"serialNumber\":\"0401805e4532973503374df52a239c898397d348\"") != std::string::npos);
}
