...
// Tests for Audio Description methods
...
{
    EXPECT_CALL(*p_store2Mock, SetValue(::testing::_, ::testing::_, USERSETTINGS_PREFERRED_AUDIO_LANGUAGES_KEY, ::testing::_, ::testing::_))
        .WillOnce(::testing::Return(Core::ERROR_GENERAL));
...
TEST_F(UserSettingsTest, SetPreferredAudioLanguages_InvalidParameter)
{
...
// Tests for Presentation Language methods
...
{
    EXPECT_CALL(*p_store2Mock, SetValue(::testing::_, ::testing::_, USERSETTINGS_PREFERRED_CAPTIONS_LANGUAGES_KEY, ::testing::_, ::testing::_))
        .WillOnce(::testing::Return(Core::ERROR_GENERAL));
...
TEST_F(UserSettingsTest, SetPreferredCaptionsLanguages_InvalidParameter)
{
...
// Tests for Preferred Closed Caption Service methods
...
{
    EXPECT_CALL(*p_store2Mock, SetValue(::testing::_, ::testing::_, USERSETTINGS_PREFERRED_CLOSED_CAPTIONS_SERVICE_KEY, ::testing::_, ::testing::_))
        .WillOnce(::testing::Return(Core::ERROR_GENERAL));
    EXPECT_EQ(Core::ERROR_GENERAL, handler.Invoke(connection, _T("setPreferredClosedCaptionService"), _T("{\"service\": \"CC3\"}"), response));
}

TEST_F(UserSettingsTest, SetPreferredClosedCaptionService_InvalidParameter)
{
...
// Tests for Privacy Mode methods
TEST_F(UserSettingsTest, GetPrivacyMode_Success)
{
    EXPECT_CALL(*p_store2Mock, GetValue(::testing::_, ::testing::_, USERSETTINGS_PRIVACY_MODE_KEY, ::testing::_, ::testing::_))
        .WillOnce(::testing::DoAll(
...
{
    EXPECT_CALL(*p_store2Mock, SetValue(::testing::_, ::testing::_, USERSETTINGS_PRIVACY_MODE_KEY, "DO_NOT_SHARE", ::testing::_))
        .WillOnce(::testing::Return(Core::ERROR_NONE));
...
{
    EXPECT_CALL(*p_store2Mock, SetValue(::testing::_, ::testing::_, USERSETTINGS_PRIVACY_MODE_KEY, ::testing::_, ::testing::_))
        .WillOnce(::testing::Return(Core::ERROR_GENERAL));
    EXPECT_EQ(Core::ERROR_GENERAL, handler.Invoke(connection, _T("setPrivacyMode"), _T("{\"privacyMode\": \"DO_NOT_SHARE\"}"), response));
}

TEST_F(UserSettingsTest, SetPrivacyMode_InvalidParameter)
{
    EXPECT_EQ(Core::ERROR_INVALID_PARAMETER, handler.Invoke(connection, _T("setPrivacyMode"), _T("{\"invalid\": \"DO_NOT_SHARE\"}"), response));
}

// Tests for Pin Control methods
...
{
    std::string restrictionsJson = "{\"scheme\":\"MPAA\",\"ratings\":[\"PG\",\"R\"]}";
    EXPECT_CALL(*p_store2Mock, SetValue(::testing::_, ::testing::_, USERSETTINGS_VIEWING_RESTRICTIONS_KEY, restrictionsJson, ::testing::_))
        .WillOnce(::testing::Return(Core::ERROR_NONE));
    EXPECT_EQ(Core::ERROR_NONE, handler.Invoke(connection, _T("setViewingRestrictions"), 
        _T("{\"viewingRestrictions\": \"{\\\"scheme\\\":\\\"MPAA\\\",\\\"ratings\\\":[\\\"PG\\\",\\\"R\\\"]}\"}"), response));
}

TEST_F(UserSettingsTest, SetViewingRestrictions_Failure)
{
    EXPECT_CALL(*p_store2Mock, SetValue(::testing::_, ::testing::_, USERSETTINGS_VIEWING_RESTRICTIONS_KEY, ::testing::_, ::testing::_))
        .WillOnce(::testing::Return(Core::ERROR_GENERAL));
    EXPECT_EQ(Core::ERROR_GENERAL, handler.Invoke(connection, _T("setViewingRestrictions"), 
        _T("{\"viewingRestrictions\": \"{\\\"scheme\\\":\\\"MPAA\\\",\\\"ratings\\\":[\\\"PG\\\",\\\"R\\\"]}\"}"), response));
}

TEST_F(UserSettingsTest, SetViewingRestrictions_InvalidParameter)
{
    EXPECT_EQ(Core::ERROR_INVALID_PARAMETER, handler.Invoke(connection, _T("setViewingRestrictions"), _T("{\"invalid\": \"restrictions\"}"), response));
}

// Tests for Viewing Restrictions Window methods
...
{
    EXPECT_CALL(*p_store2Mock, SetValue(::testing::_, ::testing::_, USERSETTINGS_VIEWING_RESTRICTIONS_WINDOW_KEY, ::testing::_, ::testing::_))
        .WillOnce(::testing::Return(Core::ERROR_GENERAL));
...
TEST_F(UserSettingsTest, SetViewingRestrictionsWindow_InvalidParameter)
{
...
// Tests for Live Watershed methods
...
{
    EXPECT_CALL(*p_store2Mock, SetValue(::testing::_, ::testing::_, USERSETTINGS_VOICE_GUIDANCE_RATE_KEY, ::testing::_, ::testing::_))
        .WillOnce(::testing::Return(Core::ERROR_GENERAL));
    EXPECT_EQ(Core::ERROR_GENERAL, handler.Invoke(connection, _T("setVoiceGuidanceRate"), _T("{\"rate\": 2.5}"), response));
}

TEST_F(UserSettingsTest, SetVoiceGuidanceRate_InvalidParameter)
{
    EXPECT_EQ(Core::ERROR_INVALID_PARAMETER, handler.Invoke(connection, _T("setVoiceGuidanceRate"), _T("{\"invalid\": 2.5}"), response));
}

// Tests for Voice Guidance Hints methods
...
{
    EXPECT_CALL(*p_store2Mock, SetValue(::testing::_, ::testing::_, USERSETTINGS_CONTENT_PIN_KEY, ::testing::_, ::testing::_))
        .WillOnce(::testing::Return(Core::ERROR_GENERAL));
    EXPECT_EQ(Core::ERROR_GENERAL, handler.Invoke(connection, _T("setContentPin"), _T("{\"contentPin\": \"1234\"}"), response));
}

TEST_F(UserSettingsTest, SetContentPin_InvalidParameter)
{
