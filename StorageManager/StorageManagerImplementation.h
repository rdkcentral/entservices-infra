...
namespace Plugin {
    ...
    public:
        ...
        virtual Core::hresult CreateStorage(const string& appId, const uint32_t& size, string& path, string& errorReason) override;
        virtual Core::hresult GetStorage(const string& appId, const int32_t& userId, const int32_t& groupId, string& path, uint32_t& size, uint32_t& used) override;
        virtual Core::hresult DeleteStorage(const string& appId, string& errorReason) override;
        virtual Core::hresult Clear(const string& appId, string& errorReason) override;
        virtual Core::hresult ClearAll(const string& exemptionAppIds, string& errorReason) override;
