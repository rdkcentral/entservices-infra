...
/*
Including this json schema here as PackageInfo struct is not used in any method
    of IAppPackagemanager Interface and thus not generated by the json generator.
It is used in OnAppDownloadStatus event which has been overriden with custom
    json response as thunder 4 does not support iterator in thunder events.
*/
...
namespace WPEFramework
{
    ...
    //Mapping for C++ enum Reason to Json Enumeration.
    ENUM_CONVERSION_BEGIN(Exchange::IPackageDownloader::Reason) // macro defined in <core/Enumerate.h>
