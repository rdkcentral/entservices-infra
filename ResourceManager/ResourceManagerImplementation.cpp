...
namespace WPEFramework {
    ...
    /* virtual */ Core::hresult ResourceManagerImplementation::SetAVBlocked(const string& appId, const bool blocked) /* override */
    {
    ...
    /* virtual */ Core::hresult ResourceManagerImplementation::GetBlockedAVApplications(IClientIterator*& clients) const /* override */
    {
    ...
    /* virtual */ Core::hresult ResourceManagerImplementation::ReserveTTSResource(const string& appId) /* override */
    {
    ...
    /* virtual */ Core::hresult ResourceManagerImplementation::ReserveTTSResourceForApps(IAppIdIterator* appids) /* override */
    {
