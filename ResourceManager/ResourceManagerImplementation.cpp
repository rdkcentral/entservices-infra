...
namespace WPEFramework {
    ...
    /* virtual */ Core::hresult ResourceManagerImplementation::ReserveTTSResource(const string& appId, Exchange::IResourceManager::TTSResult& ttsResult) /* override */
    {
        ...
        try {
            ...
            if (false == mDisableReserveTTS) {
                ...
                returnCode = Core::ERROR_NONE;
                success = true;   // RFC disabled returns true (matches original behavior)
            }
    ...
    /* virtual */ Core::hresult ResourceManagerImplementation::ReserveTTSResourceForApps(IAppIdIterator* const appids, Exchange::IResourceManager::TTSResult& ttsResult) /* override */
    {
