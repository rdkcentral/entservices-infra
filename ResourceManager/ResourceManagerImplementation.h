    ...
    namespace Plugin {
        class ResourceManagerImplementation : public Exchange::IResourceManager {
            ...
            public:
                ...
                Core::hresult SetAVBlocked(const string& appId, const bool blocked, string& message, bool& success) override;
                ...
                Core::hresult ReserveTTSResourceForApps(IAppIdIterator* const appids, Exchange::IResourceManager::TTSResult& ttsResult) override;
