    ...
    namespace Plugin {
        class ResourceManagerImplementation : public Exchange::IResourceManager {
            ...
            public:
                ...
                Core::hresult SetAVBlocked(const string& appId, const bool blocked, bool& success) override;
                Core::hresult GetBlockedAVApplications(IClientIterator*& clients, bool& success) const override;
                Core::hresult ReserveTTSResource(const string& appId, bool& success) override;
                Core::hresult ReserveTTSResourceForApps(IAppIdIterator* appids, bool& success) override;
