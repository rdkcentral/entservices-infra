...
namespace WPEFramework
{
    namespace Plugin
    {
        ...
        public:
            ...
            SceneSet()
                : PluginHost::IPlugin(), mConnectionId(0), mrefApp("rdk-reference-app"), mService(nullptr), mAppManager(nullptr), mNotification(*this)
            {
            }
        ...
        private:
            ...
            public:
                Configuration()
                    : Core::JSON::Container(), refApp()
                {
                    Add(_T("refApp"), &refApp);
                }
